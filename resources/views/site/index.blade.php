        ...
        <div class="container">
            <div class="trending-main">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="trending-tittle">
                            <strong>{{ __('index.trending_now') }}</strong>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="trending-top mb-30">
                            <div class="trend-top-img">
                                <img src="{{ asset("site/img/blog/".$trend[0]->url) }}" alt="">
                                <div class="trend-top-cap">
                                    <span>
                                        @foreach ($trend[0]->categories as $category)
                                            {{ $category->name." " }}
                                        @endforeach
                                    </span>
                                    <h2><a href="details.html">{{ $trend[0]->title }}</a></h2>
                                </div>
                            </div>
                        </div>
                        <!-- Trending Bottom -->
                        <div class="trending-bottom">
                            <div class="row">
                                @for ($i = 1; $i < count($trend) && $i <= 3; $i++)
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="{{ asset("site/img/blog/".$trend[$i]->url) }}" alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                                <span class="color1">
                                                    @foreach ($trend[$i]->categories as $category)
                                                        {{ $category->name." " }}
                                                    @endforeach
                                                </span>
                                                <h4><a href="details.html">{{ $trend[$i]->title }}</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                @endfor
                    ...
                    <!-- Riht content -->
                    <div class="col-lg-4">
                        @for ($i = 4; $i < count($trend) && $i <= 8; $i++)
                            <div class="trand-right-single d-flex">
                                <div class="trand-right-img">
                                    <img class="tmp" src="{{ asset("site/img/blog/".$trend[$i]->url) }}" alt="">
                                </div>
                            ...
                            <nav>                                                                     
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    @for ($i = 0; $i < count($categories); $i++)
                                        <a class="nav-item nav-link" data-toggle="tab" href="{{"#nav-".$i}}" role="tab" aria-selected="false">{{ $categories[$i]->name }}</a>
                                    @endfor
                                </div>
                            </nav>
                            <!--End Nav Button  -->
                                        ...
                                        @foreach ($all as $post)
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single-what-news mb-100">
                                                    <div class="what-img">
                                                        <img src="{{ asset("site/img/blog/".$post->url) }}" alt="">
                                                    </div>
                                                    <div class="what-cap">
                                                        <span class="color1">
                                                        ...
                                                        <h4><a href="{{ route("post", ["locale" => App::getLocale(), "id" => $post->id]) }}">{{ $post->title }}</a></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
